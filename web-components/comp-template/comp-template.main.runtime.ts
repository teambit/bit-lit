...
import { CompTemplateAspect } from './comp-template.aspect';

export class CompTemplateMain {
  static slots = [];
...
`,
    ...
    return new CompTemplateMain();
  }
}

CompTemplateAspect.addRuntime(CompTemplateMain);
